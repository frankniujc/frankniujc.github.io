...
3. **Copying Directories:**  
   ...
   ```
- The application [`rsync`](https://unix.stackexchange.com/questions/238152/why-is-scp-so-slow-and-how-to-make-it-faster) is a faster alternative to scp, but it is not available natively on Windows.
