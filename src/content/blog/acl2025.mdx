...
<div class="row justify-content-center text-center">
  ...
  <span style="margin-right:5px; display:inline-block;">
  <p>
    <a href="/research/acl2025/Llama See Llama Do.pdf" class="inline-block"><img height="200px" width="200px" src="/research/acl2025/slides-thumb.jpg" style="border:1px solid" alt="Slides thumbnail" data-nothumb=""></img>Slides</a>
  </p>
  </span>
</div>
...
<div class="row justify-content-center text-center">
  <div style="display: flex; justify-content: center; align-items: center;">
    ...
    <span style="margin-right:5px; display:inline-block;">
      ...
      <p class="text-center" style="font-size: 10pt;"> Now, let us zoom in on the magnitude of the increase or decrease: the difference in logits with or without the context across different tokens. Again, colour indicates token type (<b style="color:#1F77B4">blue</b>:😊, <b style="color:#E67E22">orange</b>:😵‍💫). **Observation**: The direction of change confirms the previous observation. Notably, the magnitude of change for the tokens is greater than that of the tokens. </p>
    </span>
  </div>
</div>
...
<div class="row justify-content-center">
  <img src="/research/acl2025/effect.png" alt="Demo Figure for ACL2025 Paper" style="max-width: 80%; height: auto; border: 1px solid; display: block; margin: 0 auto;" />
...
### Entrainment heads are task-specific (or relationspecific), not model-specific.
...
<div class="row justify-content-center">
  <img src="/research/acl2025/side_effect.png" alt="Demo Figure for ACL2025 Paper" style="max-width: 80%; height: auto; border: 1px solid; display: block; margin: 0 auto;" />
