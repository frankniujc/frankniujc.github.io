...
<div class="not-prose" style="margin:0.25rem 0; padding:0; text-align:center; display:flex; gap:0.5rem; justify-content:center; align-items:center; flex-wrap:nowrap; white-space:nowrap;">
  ...
  <a href="https://github.com/UKPLab/arxiv2025-icl-investigation/" style="display:inline-flex; align-items:center; text-decoration:none !important; border-bottom:none; outline:none;">
    <img src="https://img.shields.io/badge/Code-ICL Investigation-181717?style=flat&logo=github" alt="Code" />
  </a>
</div>
...
## Main Finding: ICL is neither an illusion of memorization, nor the development of an internal symbolic algorithm. It's still built on token statistics.
