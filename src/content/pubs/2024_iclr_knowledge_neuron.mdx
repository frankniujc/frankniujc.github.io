...
This contradiction may support our assertion (Niu et al., 2022) that layers are not the best explanatory device of the distribution of these types of information in LMs. [See our paper and blog post for the full discussion](/publications/2022_coling_bert_rediscover).
...
We present more results in the paper; we only see at most 5.2% of the BLiMP results being overturned. This low reliability issue is not limited to syntactic phenomena, as confirmed by Yao et al. (2023).
...
| (c) Subj-Verb Agreement: ROME only edits one subj-verb pair. |
| --- |
